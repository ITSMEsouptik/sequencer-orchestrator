...
@Component
public class ManufacturingHandler implements SagaStepHandler {

    @Override
    public EventType handlesEvent() {
        return EventType.MANUFACTURING_CRYOPRESERVATION_COMPLETE;
    }

    @Override
    public SagaResult handle(SequencerEvent event, TherapyOrder order) {
        return SagaResult.success(OrderStatus.QC_IN_PROGRESS, EventType.QC_INITIATED);
    }
}
